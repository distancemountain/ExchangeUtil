...
//		MarketServiceFactory.getInstance(com.xinqidian.business.exchange.common.Constants.EXCHANGE_NAME.EXCHANGE_COINEX).getSettlementPrice(accessKey3, secretkey3, 60, "BTCBCH");
		...
		String accessKey4 = "";
		String secretkey4 = "";
		MarketServiceFactory.getInstance(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_BINANCE).quotationTicker(accessKey4, secretkey4, "BTCUSDT");// "BNBBTC,LTCBTC"
