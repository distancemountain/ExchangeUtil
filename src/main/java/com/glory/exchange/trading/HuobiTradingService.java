...
import com.glory.exchange.common.Constants.HUOBI_ORDER_STATUS;
import com.glory.exchange.common.Constants.HUOBI_ORDER_TYPE;
...
public final class HuobiTradingService extends TradingService implements ITradingService {
	...
	public AccountInfo accountInfo(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_HOUBI+":"+HoubiAPI.account_accounts+" 请求失败", e);
		}
    	...
    	try {
			...
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_HOUBI+":"+HoubiAPI.account_accounts+" Json转Map失败", e);
		}
	...
	public Order.Response orders(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_HOUBI+":"+HoubiAPI.order_orders_place+" 请求失败", e);
		}
	...
	public Cancel.Response cancel(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_HOUBI+":"+HoubiAPI.order_orders_path$orderId_submitcancel+" 请求失败", e);
		}
...
//        		orderInfo.setFeeSymbol((String)jsonMap.get("fee_asset"));
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_HOUBI+":"+HoubiAPI.order_orders_path$orderId+" 请求失败", e);
		}
...
//            		orderInfo.setFeeSymbol((String)jsonMap.get("fee_asset"));
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_HOUBI+":"+HoubiAPI.order_openOrders+" 请求失败", e);
		}
...
//			+ ","+ Constants.HOUBI_ORDER_STATUS.submitted.getCode()
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_HOUBI+":"+HoubiAPI.order_orders+" 请求失败", e);
		}
	...
	public String depositList(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_HOUBI+":"+HoubiAPI.query_deposit_withdraw+" 请求失败", e);
		}
	...
	public AccountInfo accountBalance(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_HOUBI+":"+HoubiAPI.accounts_p$accountId_balance+" 请求失败", e);
		}
