...
import com.glory.exchange.api.OkexAPI;
import com.glory.exchange.coins.OkexProfiles;
import com.glory.exchange.common.Constants;
import com.glory.exchange.common.Constants.OKEX_ORDER_STATUS;
...
import com.glory.exchange.signature.OkexParamsSigner;
...
//		uri = uri + "&" + OkexAPI.API_SIGN_KEY_authorization +"="+ authorization;
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_OKEX +":"+ OkexAPI.api_userinfo +" 请求失败", e);
		}
...
//		uri = uri + "&" + OkexAPI.API_SIGN_KEY_authorization +"="+ authorization;
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_OKEX +":"+ OkexAPI.api_trade +" 请求失败", e);
		}
...
//		uri = uri + "&" + OkexAPI.API_SIGN_KEY_authorization +"="+ authorization;
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_OKEX +":"+ OkexAPI.api_cancel_order +" 请求失败", e);
		}
...
//    			"order_id":54614577,"orders_id":54614577,"price":0.18162686,"status":0,"symbol":"ltc_eth","type":"buy"}]}
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_OKEX +":"+ OkexAPI.api_order_info +" 请求失败", e);
		}
...
//		uri = uri + "&" + OkexAPI.API_SIGN_KEY_authorization +"="+ authorization;
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_OKEX +":"+ OkexAPI.api_order_history +" 请求失败", e);
		}
	...
	public Map<String, String> getOrdersParamsMap(Order order) {
		...
		if (ORDER_TYPE.MARKET.equals(order.getType())) {
			type = com.glory.exchange.common.Constants.OKEX_ORDER_TYPE.getByCode(order.getDirection().getCode().toLowerCase() +"_"+ order.getType().getCode().toLowerCase()).getCode().toLowerCase();
		}
