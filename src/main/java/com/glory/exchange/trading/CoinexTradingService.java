...
import com.glory.exchange.api.CoinexAPI;
import com.glory.exchange.coins.CoinexProfiles;
import com.glory.exchange.common.Constants;
import com.glory.exchange.common.Constants.COINEX_ORDER_STATUS;
...
public final class CoinexTradingService extends TradingService implements ITradingService {
	...
	public AccountInfo accountInfo(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_COINEX +":"+ CoinexAPI.balance_info +" 请求失败", e);
		}
	...
	public Order.Response orders(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_COINEX +":"+ apiUri +" 请求失败", e);
		}
	...
	public Cancel.Response cancel(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_COINEX +":"+ CoinexAPI.order_pending +" 请求失败", e);
		}
	...
	public GetOrder.Response orderInfo(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_COINEX +":"+ CoinexAPI.order_status +" 请求失败", e);
		}
	...
	public ListOrders.Response unmatchedList(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_COINEX +":"+ CoinexAPI.order_pending_list_alias +" 请求失败", e);
		}
	...
	public String historyList(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_COINEX +":"+ CoinexAPI.order_finished +" 请求失败", e);
		}
