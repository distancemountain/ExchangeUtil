...
import com.glory.beans.AccountInfo.AssetItem;
...
import com.glory.beans.OrderInfo;
import com.glory.common.Constants.EXCHANGE_NAME;
import com.glory.common.Constants.ORDER_STATUS;
import com.glory.common.Constants.ORDER_TYPE;
import com.glory.common.Constants.RESPONSE_STATUS;
import com.glory.common.Constants.TRADING_DIRECTION;
import com.glory.exchange.api.BinanceAPI;
import com.glory.exchange.coins.BinanceProfiles;
import com.glory.exchange.common.Constants;
import com.glory.exchange.common.Constants.BINANCE_ORDER_STATUS;
import com.glory.exchange.common.Constants.BINANCE_RESP_TYPE;
import com.glory.exchange.common.JacksonHelper;
import com.glory.exchange.common.RequestUtils;
import com.glory.exchange.signature.BinanceParamsSigner;
import com.glory.exchange.signature.CoinexParamsSigner;
...
public final class BinanceTradingService extends TradingService implements ITradingService {
	...
	public AccountInfo accountInfo(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_BINANCE +":"+ BinanceAPI.api_account +" 请求失败", e);
		}
	...
	public Order.Response orders(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_BINANCE +":"+ BinanceAPI.api_order +" 请求失败", e);
		}
	...
	public Cancel.Response cancel(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_BINANCE +":"+ BinanceAPI.api_cancel_order_alias +" 请求失败", e);
		}
...
//    		orderInfo.setFeeSymbol(jsonMap.get("").toString());
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_BINANCE +":"+ BinanceAPI.api_get_order_alias +" 请求失败", e);
		}
...
//    			"updateTime":1535009341169,"isWorking":true}]
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_BINANCE +":"+ BinanceAPI.api_openOrders +" 请求失败", e);
		}
	...
	public String historyList(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_BINANCE +":"+ BinanceAPI.api_allOrders +" 请求失败", e);
		}
	...
	public String depositList(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_BINANCE +":"+ BinanceAPI.wapi_depositHistory +" 请求失败", e);
		}
	...
	public String withdrawList(String accessKey, String secretkey, ISignature signature) {
    	...
    	try {
			...
			e.printStackTrace();
			super.logger.error(com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_BINANCE +":"+ BinanceAPI.wapi_withdrawHistory +" 请求失败", e);
		}
