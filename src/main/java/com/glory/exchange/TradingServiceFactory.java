...
import com.glory.exchange.trading.BinanceTradingService;
import com.glory.exchange.trading.CoinexTradingService;
import com.glory.exchange.trading.HuobiTradingService;
import com.glory.exchange.trading.ITradingService;
...
public class TradingServiceFactory {
	...
	public static TradingServiceSPI getInstance(com.glory.common.Constants.EXCHANGE_NAME exchange) {
	...
	public final static class TradingServiceSPI {
		...
		public TradingServiceSPI(com.glory.common.Constants.EXCHANGE_NAME exchange) {
			if (com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_HOUBI.equals(exchange)) {
				tradingService = new HuobiTradingService();
				signature = new HuobiParamsSigner();
			} else if (com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_COINEX.equals(exchange)) {
				tradingService = new CoinexTradingService();
				signature = new CoinexParamsSigner();
			} else if (com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_OKEX.equals(exchange)) {
				tradingService = new OkexTradingService();
				signature = new OkexParamsSigner();
			} else if (com.glory.common.Constants.EXCHANGE_NAME.EXCHANGE_BINANCE.equals(exchange)) {
